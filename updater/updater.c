...
// Where in the package we expect to find file_contexts
#define SELINUX_CONTEXTS_ZIP "file_contexts"
// Where we will put the file_contexts after extracting
...
int main(int argc, char** argv) {
    ...
    // Extract file_contexts from package if it exists
